...
import { BrainCircuit, TrendingUp, Users, AlertCircle, Sparkles, RefreshCw, Calendar } from 'lucide-react';
    ...
    <div className="space-y-10">
      ...
      <div className="glass-card overflow-hidden">
        <div className="p-8 border-b border-border flex items-center justify-between bg-muted/20">
          ...
          <button className="tech-label px-6 py-3 rounded-xl bg-primary/10 text-primary border border-primary/20 hover:bg-primary hover:text-white transition-all">
            Aprovar Todos
          </button>
        </div>
              ...
              {predictions.length > 0 ? predictions.map((p) => (
                <tr key={p.id} className="hover:bg-muted/20 transition-colors group">
                  ...
                  <td className="px-10 py-8 text-right">
                    <button className="emerald-glow px-6 py-3 rounded-xl tech-label font-bold hover:scale-105 transition-all">
                      Enviar
                    </button>
                  </td>
                </tr>
